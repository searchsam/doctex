...
\begin{document}
    ...
    .\hspace{1cm} Historia \dotfill 3\\
    .\hspace{1cm} Estructura de la Misa \dotfill 4\\
    .\hspace{1cm} Ordinario \dotfill 6\\
    .\hspace{1cm} Propio \dotfill 6

    \noindent
    \textbf{Ordinario de la Misa \hfill{9}}\\
    .\hspace{1cm} Señor ten piedad \dotfill 10\\
    .\hspace{1cm} Gloria a Dios en lo alto del cielo \dotfill 16\\
    .\hspace{1cm} Credo \dotfill 26\\
    .\hspace{1cm} Santo \dotfill 39\\
    .\hspace{1cm} Cordero de Dios \dotfill 48

    \noindent
    \textbf{Propio de la Misa \hfill{57}}\\
    .\hspace{1cm} Canto de Entrada \dotfill 58\\
    .\hspace{1cm} Salmo Responsorial \dotfill 69\\
    .\hspace{2cm} \textit{Ciclo A} \dotfill 69\\
    .\hspace{2cm} \textit{Ciclo B} \dotfill 79\\
    .\hspace{2cm} \textit{Ciclo C} \dotfill 86\\
    .\hspace{1cm} Aleluya \dotfill 93\\
    .\hspace{1cm} Presentación de Ofrendas \dotfill 98\\
    .\hspace{1cm} Canto de Comunión \dotfill 112\\
    .\hspace{1cm} Canto de Despedida \dotfill 122
    \clearpage
